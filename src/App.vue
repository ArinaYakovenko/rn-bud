...
<template>
  <div class="min-h-screen bg-[#faf9f7] text-slate-900 selection:bg-[#0f4c81] selection:text-white">
    ...
    <header class="sticky top-0 z-30 border-b border-slate-200 bg-white/95 backdrop-blur">
      <div class="mx-auto flex container items-center justify-between px-4 py-3 sm:px-6 lg:px-8 xl:px-10">
        ...
        <router-link to="/" class="flex items-center gap-3" @click="closeMenu">
          <img :src="logoUrl" alt="RN-BUD logo" class="h-11 w-11 rounded-full border-2 object-cover" style="border-color: #0f4c81;" />
          <div>
        ...
        <div class="grid gap-10 py-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div class="sm:col-span-2 lg:col-span-1">
            <div class="flex items-center gap-3">
              <img :src="logoUrl" alt="RN-BUD" class="h-10 w-10 rounded-full border-2 object-cover" style="border-color: #0f4c81;" />
              <div>
          ...
          <div>
            ...
            <ul class="mt-4 space-y-3 text-sm text-slate-600">
              ...
              <li>
                <a :href="contact.oferteo" target="_blank" rel="noreferrer noopener" class="inline-flex items-center gap-1 font-medium hover:opacity-80" style="color: #0f4c81;">
                  Profil na Oferteo →
                </a>
              </li>
            </ul>
